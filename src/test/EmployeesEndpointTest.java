...
@QuarkusTest
public class EmployeesEndpointTest {


    @Test
    public void testListAllFirstNames() {
        ...
        Response response = given()
                ...
                .extract().response();
        List<Object> firstNameList = response.jsonPath().getList("first_name");
        assertThat(firstNameList)
                .contains("Tony", "sid", "fum", "damn");
